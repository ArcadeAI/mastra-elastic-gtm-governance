/**
 * This service knows people, not sales leads and not policy. It is the enterprise's
...
/**
 * Comments are stripped before matching, as in the lead system's sibling test:
...
describe("apps/idp knows people, not leads", () => {
  test.each([
    ["lead", /\bleads?\b/i],
    ["prospect", /\bprospects?\b/i],
    ["company domain", /\bcompany_domain\b/i],
    ["estimated ACV", /\bestimated_acv\b/i],
    ["disposition", /\bdisposition\b/i],
