...
const stages = [
  { id: "supplied", label: "1 · Build your agent", hint: "Mastra", prompt: "Northwind’s renewal is coming up and usage has dropped. What do usage and support history tell us, and does the evidence support their requested 30% discount?" },
  { id: "elastic", label: "2 · Connect evidence", hint: "Elastic through Arcade", prompt: "Northwind’s renewal is coming up and usage has dropped. What do usage and support history tell us, and does the evidence support their requested 30% discount? Search Elastic and cite source IDs." },
  { id: "governed", label: "3 · Act with approval", hint: "Arcade + Slack", prompt: "Northwind’s renewal is coming up. Review usage and support history for ACC-2291, prepare the requested 30% discount, and draft a customer follow-up explaining the offer. Acknowledge open issues without promising a fix. Double-check the saved offer and email draft." },
] as const;
...
export function Workshop({ approvalId }: { approvalId?: string }) {
  ...
  return <main className="workshop-shell">
    ...
    </section><aside className="workshop-card workflow-panel"><p className="eyebrow">THE CONNECTED WORKFLOW</p><ol><li>Mastra investigates renewal risk</li><li>Elastic supplies usage and support evidence</li><li>Arcade filters sensitive details and checks the discount</li><li>Slack delivers the approval request</li><li>Riley approves; Dana’s agent saves and checks the offer and follow-up</li></ol>
