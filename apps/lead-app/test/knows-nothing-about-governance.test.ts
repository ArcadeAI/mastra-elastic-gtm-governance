 ...
 *
 * `apps/lead-app` is the system being governed. If a check ever appears in
 ...
 * not automatically a bug — but it means someone taught the lead service
...
describe("apps/lead-app knows nothing about governance", () => {
